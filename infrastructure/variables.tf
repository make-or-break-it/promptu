...
variable "promptu_feeder_api_cidr_range" {
  type        = string
  description = "The CIDR range for the Promptu Feeder API application to be whitelisted by MongoDB Atlas"
  default     = "0.0.0.0/0"
}

variable "promptu_db_updater_cidr_range" {
  type        = string
  description = "The CIDR range for the Promptu DB Updater application to be whitelisted by MongoDB Atlas"
  default     = "0.0.0.0/0"
}
