...
3. **Setup Terraform Cloud (free)**
   ...
   flyctl secrets set -a promptu-api-<your-suffix> --detach PROMPTU_MONGODB_URL="mongodb+srv://promptu:<password from section 3.6>@<hostname from section 3.7>"
   ```
